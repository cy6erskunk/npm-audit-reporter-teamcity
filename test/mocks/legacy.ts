import { IAuditLegacyOutput } from '../../src/legacy/model';

export const noVulnerabilities: IAuditLegacyOutput = {
  actions: [],
  advisories: {},
  muted: [],
  metadata: {
...
export const multipleVulnerabilities: IAuditLegacyOutput = {
  actions: [
    {
      action: 'install',
      module: 'jest',
